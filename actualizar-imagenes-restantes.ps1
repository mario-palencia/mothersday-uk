# Script para actualizar las imágenes restantes de ciudades desde Unsplash
# Usa las nuevas URLs proporcionadas por el usuario
...
# Nuevas URLs de Unsplash proporcionadas por el usuario
$cityPhotoIds = @{
    'atlanta' = 'XV81dRUMzpo'
    'washington-dc' = 'ra3oAd6hrnM'
    'melbourne' = 'gmtAa0Q5MI'
    'valencia' = '7b0EXl2NaE8'
    'los-angeles' = 'UZVlSjrIJ3o'
    'brisbane' = 'RJII3O7CTeo'
    'hamburg' = 'nt1NvYrnxsg'
}

Write-Host "`n=== Actualizando imagenes restantes de ciudades ===" -ForegroundColor Cyan
...
foreach ($city in $cityPhotoIds.Keys) {
    ...
    $urls = @(
        # Method 1: Direct download endpoint
